...
private:
	...
	TransformManager ThirdPersonCameraTransform = glm::vec3(0, 10, -10);    //Sets the Third person Camera transform
	...
	TransformManager SunTransfrom = glm::vec3(0, 0,-450);                //Sets the Transform for the Sun
	...
	bool ThirdPerson = true;       //Checks if the Third Person Camera is selected 
